#Coded By suhaib ... And Copyright Ofc xD 
...
######## Work ########
def steam() :
 print("""  Steam Generator (c)suhaibr """)
 ...
 try :
   ...
   if so =='y' or so =='Y':
    ...
    exit()
	   	 ...
	   	 pass
def hma() :
 print("""  Hidemyass Generator (c)suhaiber """)
 zz=input('Enter Number Keys > ')
 try :
   for az in range(int(zz)) :
    urname = string.ascii_letters + string.digits
...
def gplay() :
 print("""  Googleplay Generator (c)suhaib """)
 zz=input('Enter Number Keys > ')
 int(zz)
 try :
   for az in range(int(zz)) :
